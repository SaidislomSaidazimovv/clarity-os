...
export default function DashboardPanel({ formData }) {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      doc.text("Brand Blueprint", pageWidth / 2, yPosition, {
        align: "center",
      });
      ...
      doc.text("Generated by ClarityOS Engine", pageWidth / 2, yPosition, {
        align: "center",
      });
      ...
      doc.text("✨ Brand Summary", 15, yPosition);
      yPosition += 10;
      ...
      doc.setFontSize(16);
      doc.setTextColor(0, 0, 0);
      doc.text("🧬 Strategic Insights", 15, yPosition);
      yPosition += 10;
      ...
      doc.setFont(undefined, "bold");
      doc.text("Dominant Archetype:", 20, yPosition);
      doc.setFont(undefined, "normal");
      doc.text(analyzeFormData.dominantArchetype || "---", 70, yPosition);
      yPosition += 10;

      doc.setFont(undefined, "bold");
      doc.text("Core Motivation:", 20, yPosition);
      yPosition += 7;
      doc.setFont(undefined, "normal");
      ...
      doc.text(
        `Generated on ${timestamp} | Powered by ClarityOS Engine`,
        pageWidth / 2,
        pageHeight - 10,
        { align: "center" }
      );

      const fileName = `${analyzeFormData.name}_Blueprint_${Date.now()}.pdf`;
      doc.save(fileName);
